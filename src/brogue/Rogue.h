...
#define BROGUE_VERSION_STRING "RB+I " STRINGIFY(BROGUE_MAJOR) "." STRINGIFY(BROGUE_MINOR) "." STRINGIFY(BROGUE_PATCH) BROGUE_EXTRA_VERSION

// Recording version. Saved into recordings and save files made by this version.
// Cannot be longer than 16 chars
#define BROGUE_RECORDING_VERSION_STRING "RB+I " STRINGIFY(BROGUE_MAJOR) "." STRINGIFY(BROGUE_MINOR) "." STRINGIFY(BROGUE_PATCH)
...
*/
#define BROGUE_PATCH_VERSION_PATTERN "RB+I " STRINGIFY(BROGUE_MAJOR) "." STRINGIFY(BROGUE_MINOR) ".%hu"

// Dungeon version. Used in seed catalog output.
#define BROGUE_DUNGEON_VERSION_STRING "RB+I 1.0.0"
